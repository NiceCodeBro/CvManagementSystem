...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.3.0/js/bootstrap-datepicker.js"></script>
	...
	<div class="row setup-content" id="step-4">
      <div class="col-xs-6 col-md-offset-3">
      	...
      	<!-- ekleme butonu -->
        <button id="addCheckbox2" class="btn btn-success">+</button>
        ...
        <hr id="ayrac2" style="width: 100%; color: black; height: 1px; background-color:black;" />
      ...
      <div class="col-xs-6 col-md-offset-3">
		...
		<div class="container">
			...
			<div class="row">
			    ...
			    <div class="row lead"> Reading Score 
	    	...
	    	<div class="row">
			    <div class="row lead">Writting Score
			        <div id="stars2" class="starrr"></div>
				</div>
		    </div>
		    
		    <div class="row">			
			    <div class="row lead"> Speaking Score 
		       ...
		       <!--  
          	STAR KAYNAK KODU--- yıldız değerlerine üstteki gibi spanla erişiyorsun fakat bunu generic olarak + ile çoğaltırsak 2. yabancı dil de 
          						1. yabancı dilin skorlarını alacak. nasıl çözülür bilmiyorum
          						
          						belki 5 6 dil varmış gibi js kodu ekleriz, + ya basınca ek olarak id'leri 1 arttırarak ekler.
          	
          https://bootsnipp.com/snippets/featured/functional-star-ratings 
          
          Şöyle de bişey var; http://plugins.krajee.com/star-rating-demo-basic-usage
          fakat ekleyemedim istediğim gibi
          -->
 ...
 <!-- SKILLS START -->
      ...
      <div class="col-xs-6 col-md-offset-3">
		...
		<!-- 
			...
			SKİLL İÇİN KAYNAK BURDA, ÇAKIŞMA OLDU GENE ÇALIŞMADI JS
			http://sliptree.github.io/bootstrap-tokenfield/#copy-paste
